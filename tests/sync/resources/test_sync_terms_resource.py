...
def client_mock() -> Any:
    ...
    client.put_json = Mock()
    client.delete_json = Mock()
    return client


def test_add_calls_expected_endpoint_and_returns_dict(client_mock: Any) -> None:
    ...
    result = resource.add({"description": "Payment term A"})
...
def test_find_with_params(client_mock: Any) -> None:
    ...
    resource = TermsResource(client_mock)
    resource.find(params={"filter": "active"})

    client_mock.get_json.assert_called_once_with("/terms/find", params={"filter": "active"})


def test_find_returns_empty_list_when_container_is_empty(client_mock: Any) -> None:
...
def test_get_calls_expected_endpoint_and_returns_dict(client_mock: Any) -> None:
...
def test_edit_calls_expected_endpoint_and_returns_dict(client_mock: Any) -> None:
    ...
    resource = TermsResource(client_mock)
    result = resource.edit(1, {"description": "Updated Term"})
...
def test_edit_uses_post_method(client_mock: Any) -> None:
    ...
    resource = TermsResource(client_mock)
    resource.edit(1, {"description": "Updated"})

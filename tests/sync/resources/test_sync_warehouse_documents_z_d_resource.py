"""Tests for synchronous ZD warehouse documents resource.
...
class TestWarehouseDocumentZDResourceGet:
    ...
    # AICOMPLETE: Sync warehouse_document_z_d GET returns WarehouseDocument model - ready for review
...
class TestWarehouseDocumentZDResourceFind:
    ...
    # AICOMPLETE: Sync warehouse_document_z_d FIND returns list of WarehouseDocuments - ready for review
    ...
    # AICOMPLETE: Sync warehouse_document_z_d FIND handles empty result - ready for review
...
class TestWarehouseDocumentZDResourceAdd:
    ...
    # AICOMPLETE: Sync warehouse_document_z_d ADD creates and returns WarehouseDocument - ready for review
    def test_add_calls_expected_endpoint_and_returns_model(self) -> None:
        ...
        with respx.mock:
            ...
            result = resource.add({"fullnumber": "ZD 3/2024", "date": "2024-01-20", "type": "z_d"})
...
class TestWarehouseDocumentZDResourceEdit:
    ...
    # AICOMPLETE: Sync warehouse_document_z_d EDIT updates and returns WarehouseDocument - ready for review
    def test_edit_calls_expected_endpoint_and_returns_model(self) -> None:
        ...
        with respx.mock:
            ...
            result = resource.edit(456, {"fullnumber": "ZD 9/2024"})
...
class TestWarehouseDocumentZDResourceDelete:
    ...
    # AICOMPLETE: Sync warehouse_document_z_d DELETE returns True - ready for review

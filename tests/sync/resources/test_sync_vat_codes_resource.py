"""Tests for synchronous vat_codes resource.
...
class TestVatCodesResourceGet:
    """Tests for VatCodesResource.get() method."""
    ...
    def test_get_calls_expected_endpoint_and_returns_payload(self) -> None:
        ...
        with respx.mock:
            ...
            result = resource.get(vat_code_id=456)
...
class TestVatCodesResourceFind:
    """Tests for VatCodesResource.find() method."""

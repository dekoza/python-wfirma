"""Tests for async API Key authentication.
...
Note: The APIKeyAuth class is synchronous data - the same tests apply as for sync.
"""
...
class TestAPIKeyAuth:
    """Tests for async APIKeyAuth class."""

    # AICOMPLETE: API Key authentication (async) - ready for review
...
class TestAPIKeyAuthFromEnv:
    """Tests for async APIKeyAuth.from_env class method."""

    # AICOMPLETE: API Key authentication from environment (async) - ready for review

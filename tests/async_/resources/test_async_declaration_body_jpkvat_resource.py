"""Tests for asynchronous declaration_body_jpkvat resource.

These tests verify that the async resource calls the expected parameterized-path
endpoint and properly extracts payload from the response.
"""
...
class TestDeclarationBodyJpkvatResourceGet:
    ...
    @pytest.mark.asyncio
    async def test_get_calls_expected_endpoint_with_path_parameters(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_returns_dict_not_raw_response(self) -> None:

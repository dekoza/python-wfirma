"""Tests for asynchronous R warehouse documents resource.
...
class TestWarehouseDocumentRResourceGet:
    ...
    # AICOMPLETE: Async warehouse_document_r GET returns WarehouseDocument model - ready for review
...
class TestWarehouseDocumentRResourceFind:
    ...
    # AICOMPLETE: Async warehouse_document_r FIND returns list of WarehouseDocuments - ready for review
    ...
    # AICOMPLETE: Async warehouse_document_r FIND handles empty result - ready for review
...
class TestWarehouseDocumentRResourceAdd:
    ...
    # AICOMPLETE: Async warehouse_document_r ADD creates and returns WarehouseDocument - ready for review
    async def test_add_calls_expected_endpoint_and_returns_model(self) -> None:
        ...
        async with WFirmaClient(auth=auth, company_id=123) as client:
            ...
            with respx.mock:
                ...
                result = await resource.add({"fullnumber": "R 3/2024", "date": "2024-01-20", "type": "r"})
...
class TestWarehouseDocumentRResourceEdit:
    ...
    # AICOMPLETE: Async warehouse_document_r EDIT updates and returns WarehouseDocument - ready for review
    async def test_edit_calls_expected_endpoint_and_returns_model(self) -> None:
        ...
        async with WFirmaClient(auth=auth, company_id=123) as client:
            ...
            with respx.mock:
                ...
                result = await resource.edit(456, {"fullnumber": "R 9/2024"})
...
class TestWarehouseDocumentRResourceDelete:
    ...
    # AICOMPLETE: Async warehouse_document_r DELETE returns True - ready for review

"""Tests for asynchronous PZ warehouse documents resource.
...
class TestWarehouseDocumentPZResourceGet:
    ...
    # AICOMPLETE: Async warehouse_document_p_z GET returns WarehouseDocument model - ready for review
    async def test_get_calls_expected_endpoint_and_returns_model(self) -> None:
        ...
        async with WFirmaClient(auth=auth, company_id=123) as client:
            ...
            with respx.mock:
                route = respx.get(
                    "https://sandbox-api2.wfirma.pl/warehouse_document_p_z/get/53487196",
                    params={
                        "outputFormat": "json",
                        "company_id": "123",
                    },
...
class TestWarehouseDocumentPZResourceFind:
    ...
    # AICOMPLETE: Async warehouse_document_p_z FIND returns list of WarehouseDocuments - ready for review
    async def test_find_calls_expected_endpoint_and_returns_list(self) -> None:
        ...
        async with WFirmaClient(auth=auth, company_id=123) as client:
            ...
            with respx.mock:
                route = respx.get(
                    "https://sandbox-api2.wfirma.pl/warehouse_document_p_z/find",
                    params={
                        "outputFormat": "json",
                        "company_id": "123",
                    },
    ...
    # AICOMPLETE: Async warehouse_document_p_z FIND handles empty result - ready for review
...
class TestWarehouseDocumentPZResourceAdd:
    ...
    # AICOMPLETE: Async warehouse_document_p_z ADD creates and returns WarehouseDocument - ready for review
    async def test_add_calls_expected_endpoint_and_returns_model(self) -> None:
        ...
        async with WFirmaClient(auth=auth, company_id=123) as client:
            ...
            with respx.mock:
                route = respx.post(
                    "https://sandbox-api2.wfirma.pl/warehouse_document_p_z/add",
                    params={
                        "inputFormat": "json",
                        "outputFormat": "json",
                        "company_id": "123",
                ...
                result = await resource.add(
                    {"fullnumber": "PZ 3/2024", "date": "2024-01-20", "type": "p_z"}
                )
...
class TestWarehouseDocumentPZResourceEdit:
    ...
    # AICOMPLETE: Async warehouse_document_p_z EDIT updates and returns WarehouseDocument - ready for review
    async def test_edit_calls_expected_endpoint_and_returns_model(self) -> None:
        ...
        async with WFirmaClient(auth=auth, company_id=123) as client:
            ...
            with respx.mock:
                route = respx.post(
                    "https://sandbox-api2.wfirma.pl/warehouse_document_p_z/edit/456",
                    params={
                        "inputFormat": "json",
                        "outputFormat": "json",
                        "company_id": "123",
                ...
                result = await resource.edit(456, {"fullnumber": "PZ 9/2024"})
...
class TestWarehouseDocumentPZResourceDelete:
    ...
    # AICOMPLETE: Async warehouse_document_p_z DELETE returns True - ready for review
    async def test_delete_calls_expected_endpoint_and_returns_true(self) -> None:
        ...
        async with WFirmaClient(auth=auth, company_id=123) as client:
            ...
            with respx.mock:
                route = respx.delete(
                    "https://sandbox-api2.wfirma.pl/warehouse_document_p_z/delete/456",
                    params={
                        "outputFormat": "json",
                        "company_id": "123",
                    },

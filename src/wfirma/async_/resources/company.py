"""Company-related resource endpoints (asynchronous).
...
class CompanyResource:
    ...
    async def get(self, company_id: int | None = None) -> CompanyDetail:
        """Get company details.
    ...
    async def find_main_address(self) -> CompanyAddress:
        ...
        """
        data = await self._client.get_json("/company_addresses/findmain")

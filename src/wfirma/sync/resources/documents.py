"""Document-related resource endpoints (synchronous).
...
class DocumentsResource:
    ...
    def find(self, params: dict[str, Any] | None = None) -> list[dict[str, Any]]:
        ...
        """
        data = self._client.get_json("/documents/find", params=params)
    ...
    def get(self, document_id: int) -> dict[str, Any]:
        ...
        """
        data = self._client.get_json(f"/documents/get/{document_id}")
        return self._extract_document_payload(data)
    ...
    def download(self, document_id: int) -> bytes:
        ...
        Returns:
            Binary PDF content.
        """
        return self._client.get_binary(f"/documents/download/{document_id}")
    ...
    def delete(self, document_id: int) -> dict[str, Any]:
        ...
        """
        data = self._client.delete_json(f"/documents/delete/{document_id}")
        return self._extract_document_payload(data)

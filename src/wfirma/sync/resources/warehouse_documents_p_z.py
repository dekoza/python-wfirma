"""Warehouse document (PZ) resource endpoints (synchronous).
...
class WarehouseDocumentPZResource:
    """Synchronous resource for PZ warehouse documents.
    ...
    def get(self, warehouse_document_id: int) -> WarehouseDocument:
        ...
        """
        data = self._client.get_json(f"/warehouse_document_p_z/get/{warehouse_document_id}")
    ...
    def find(self) -> list[WarehouseDocument]:
        ...
        """
        data = self._client.get_json("/warehouse_document_p_z/find")
    ...
    def add(self, document: dict[str, Any]) -> WarehouseDocument:
        ...
        data = self._client.post_json("/warehouse_document_p_z/add", data=payload)
    ...
    def delete(self, warehouse_document_id: int) -> bool:
        ...
        """
        self._client.delete_json(f"/warehouse_document_p_z/delete/{warehouse_document_id}")
        return True

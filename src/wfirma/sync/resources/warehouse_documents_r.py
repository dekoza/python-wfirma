"""Warehouse document (R) resource endpoints (synchronous).
...
class WarehouseDocumentRResource:
    """Synchronous resource for R warehouse documents.
    ...
    def get(self, warehouse_document_id: int) -> WarehouseDocument:
        ...
        """
        data = self._client.get_json(f"/warehouse_document_r/get/{warehouse_document_id}")
    ...
    def find(self) -> list[WarehouseDocument]:
        ...
        """
        data = self._client.get_json("/warehouse_document_r/find")
    ...
    def add(self, document: dict[str, Any]) -> WarehouseDocument:
        ...
        data = self._client.post_json("/warehouse_document_r/add", data=payload)
    ...
    def delete(self, warehouse_document_id: int) -> bool:
        ...
        """
        self._client.delete_json(f"/warehouse_document_r/delete/{warehouse_document_id}")
        return True

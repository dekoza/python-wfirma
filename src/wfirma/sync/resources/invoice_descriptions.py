"""Invoice descriptions-related resource endpoints (synchronous).
...
class InvoiceDescriptionsResource:
    """Synchronous invoice_descriptions resource."""

    def __init__(self, client: WFirmaClient) -> None:
        self._client = client

    def get(self, invoice_description_id: int) -> dict[str, Any]:
        ...
        """
        data = self._client.get_json(f"/invoice_descriptions/get/{invoice_description_id}")

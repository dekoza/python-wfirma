"""Warehouse document (ZPD) resource endpoints (synchronous).
...
class WarehouseDocumentZPDResource:
    """Synchronous resource for ZPD warehouse documents.
    ...
    def get(self, warehouse_document_id: int) -> WarehouseDocument:
        ...
        """
        data = self._client.get_json(f"/warehouse_document_z_p_d/get/{warehouse_document_id}")
    ...
    def find(
        ...
        *,
        ...
        if conditions is None and limit is None and page is None:
            data = self._client.get_json("/warehouse_document_z_p_d/find")
        else:
    ...
    def add(self, document: dict[str, Any]) -> WarehouseDocument:
        ...
        data = self._client.post_json("/warehouse_document_z_p_d/add", data=payload)
    ...
    def delete(self, warehouse_document_id: int) -> bool:
        ...
        """
        self._client.delete_json(f"/warehouse_document_z_p_d/delete/{warehouse_document_id}")
        return True

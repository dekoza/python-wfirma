"""Company packs-related resource endpoints (synchronous).
...
class CompanyPacksResource:
    """Synchronous company_packs resource."""

    def __init__(self, client: WFirmaClient) -> None:
        self._client = client

    def get(self, company_pack_id: int) -> dict[str, Any]:
        ...
        """
        data = self._client.get_json(f"/company_packs/get/{company_pack_id}")

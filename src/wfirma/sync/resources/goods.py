"""Good-related resource endpoints (synchronous).
...
class GoodsResource:
    ...
    def get(self, good_id: int) -> Good:
        ...
        """
        data = self._client.get_json(f"/goods/get/{good_id}")
    ...
    def add(
        ...
        *,
        ...
        data = self._client.post_json("/goods/add", data=payload)
    ...
    def edit(
        ...
        *,
        ...
        payload = GoodsUpsertRequest.from_good_data(good_data).model_dump(mode="json")
        data = self._client.post_json(f"/goods/edit/{good_id}", data=payload)
        result_payload = self._extract_good_payload(data)
        return Good.model_validate(result_payload)

    def delete(self, good_id: int) -> bool:
        """Delete a good.

        Endpoint: DELETE /goods/delete/{goodId}
        """
        self._client.delete_json(f"/goods/delete/{good_id}")
        return True

"""Warehouse document (WZ) resource endpoints (synchronous).
...
class WarehouseDocumentWZResource:
    """Synchronous resource for WZ warehouse documents.
    ...
    def get(self, warehouse_document_id: int) -> WarehouseDocument:
        ...
        """
        data = self._client.get_json(f"/warehouse_document_w_z/get/{warehouse_document_id}")
    ...
    def find(self) -> list[WarehouseDocument]:
        ...
        """
        data = self._client.get_json("/warehouse_document_w_z/find")
    ...
    def add(self, document: dict[str, Any]) -> WarehouseDocument:
        ...
        data = self._client.post_json("/warehouse_document_w_z/add", data=payload)
    ...
    def delete(self, warehouse_document_id: int) -> bool:
        ...
        """
        self._client.delete_json(f"/warehouse_document_w_z/delete/{warehouse_document_id}")
        return True

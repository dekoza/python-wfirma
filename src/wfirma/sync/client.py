...
class WFirmaClient:
    ...
    def get_json(
        ...
        *,
        ...
        return self.get(path, params=params, user_scoped=user_scoped)
    ...
    def post_json(
        ...
        *,
        ...
        params["outputFormat"] = "json"
        return self.post(path, json=data, params=params, user_scoped=user_scoped)
    ...
    def patch(
        ...
        *,
        ...
        try:
            if json is not None:
                response = self._http_client.patch(url, headers=headers, json=json, params=params)
            else:
    ...
    def post_binary(
        ...
        *,
        ...
        try:
            response = self._http_client.post(url, headers=headers, json=data, params=params)
        except httpx.TimeoutException as err:
            raise TimeoutError("Request timed out.") from err
        except httpx.ConnectError as err:
            raise ConnectionError("Failed to connect to the server.") from err

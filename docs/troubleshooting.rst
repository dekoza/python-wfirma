...
A: ``1.0b2`` is a beta release. ``WFirmaClient`` now supports API Key, OAuth2, and OAuth1, but you should still validate your exact flows and accept API churn before ``1.0.0``.
